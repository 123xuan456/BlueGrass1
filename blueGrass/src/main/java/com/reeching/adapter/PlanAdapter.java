...
public class PlanAdapter extends BaseAdapter{
    ...
    public PlanAdapter(List<HuaLangShowing.Infos> lists, Context context) {
        this.lists = lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PlanAdapter.viewholder vh = null;
        if (convertView == null) {
            vh = new PlanAdapter.viewholder();
            ...
            vh = (PlanAdapter.viewholder) convertView.getTag();
        }
