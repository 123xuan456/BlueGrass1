    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comeback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HaveVerificationActivity.this.finish();
            }
        });
        ...
        mLV_AfterSalesInfor.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                ...
                hu.send(HttpMethod.POST, HttpApi.ip + HttpApi.haveverification, params,
                        new RequestCallBack<String>() {
                            ...
                            public void onSuccess(ResponseInfo<String> arg0) {
                                ...
                                if (showing.getResult().equals("1")) {
                                    ...
                                    Toast.makeText(HaveVerificationActivity.this,
