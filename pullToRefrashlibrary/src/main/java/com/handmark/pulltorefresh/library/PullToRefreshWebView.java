...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	protected boolean isReadyForPullEnd() {
		...
		float exactContentHeight = (float)Math.ceil(mRefreshableView.getContentHeight() * mRefreshableView.getScale());
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		private int getScrollRange() {
			return (int) Math.max(0, (float)Math.ceil(mRefreshableView.getContentHeight() * mRefreshableView.getScale())
